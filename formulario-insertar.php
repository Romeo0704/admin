...
&& isset($_POST['puebas']) && isset($_POST['responsable']) && isset($_POST['evidencias']) && isset($_POST['fecha_inicio_atencion']) && isset($_POST['fecha_termino_cap'])
...
&& isset($_POST['porcentaje_cap']) && isset($_POST['comentarios']) && isset($_POST['fecha_subio_olf']) && isset($_POST['fecha_revision_oaci'])){
    ...
    $conexion->query("insert into formulario(num_pq,area,elemento,pregunta,orientacion,documentos,fecha_inicio,fecha_termino,porcentaje,introduccion,fundamentos,
                        cumplimiento,intervenciones,conclusion,puebas,responsable,evidencias,fecha_inicio_atencion,fecha_termino_cap,
        ...
        values (
            ...
            '".$_POST['puebas']."','".$_POST['responsable']."','".$_POST['evidencias']."','".$_POST['fecha_inicio_atencion']."',
