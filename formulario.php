                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" name="sin_contestar" class="form-control" id="sin_contestar" placeholder="" disabled>
                                            </div>
                                            <div class="col">
                                                <label for="satisfactoria">Satisfactoria</label><br><br>
                                                <input type="text" name="satisfactoria" class="form-control" id="satisfactoria" placeholder="" disabled>
                                            </div>
                                            <div class="col">
                                                <label for="no_satisfactoria">No satisfactoria</label><br><br>
                                                <input type="text" name="no_satisfactoria" class="form-control" id="no_satisfactoria" placeholder="" disabled>
                                            </div>
                                            <div class="col">
                                                <label for="no_aplica">No aplica</label><br><br>
                                                <input type="text" name="no_aplica" class="form-control" id="no_aplica" placeholder="" disabled>
                                            </div>
                                            <div class="col">
                                                <div class="col">
                                                    <label for="ssc">SSC</label>
                                                    <input type="text" name="ssc" class="form-control" id="ssc" placeholder="" disabled>
                                                </div>
                                                <div class="col">
                                                    <label for="mir">MIR</label>
                                                    <input type="text" name="mir" class="form-control" id="mir" placeholder="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                        <div class="card-body">
                            ...
                            <form>
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="date" name="fecha_inicio" class="form-control" id="fecha_inicio" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="fecha_termino">Fecha de término de la AE</label>
                                        <input type="date" name="fecha_termino" class="form-control" id="fecha_termino" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="porcentaje">Porcentaje total actual de la PQ</label>
                                        <input type="text" name="porcentaje" class="form-control" id="porcentaje" placeholder="">
                                    </div>
                                </div>
                            </form>
                            <br>
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="introduccion">Introducción. (área responsable, funciones respectivas, obligaciones)</label>
                                    <textarea type="text" name="introduccion" class="form-control" id="introduccion" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="fundamentos">Descripción de Fundamentos. (resumen de las referencias OACI) </label>
                                    <textarea type="text" name="fundamentos" class="form-control" id="fundamentos" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="cumplimiento">Evaluación de cumplimiento actual. (panorama actual referente a la PQ) <br> 
                                        Alinear respuesta con la Orientación para el examen de pruebas.</label>
                                    <textarea type="text" name="cumplimiento" class="form-control" id="cumplimiento" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="intervenciones">Intervenciones de áreas de la AFAC. (quienes y en que intervienen)</label>
                                    <textarea type="text" name="intervenciones" class="form-control" id="intervenciones" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="conclusion">Conclusión de cumplimiento. (total, parcial, nada)</label>
                                    <textarea type="conclusion" name="conclusion" class="form-control" id="conclusion" rows="3"></textarea>
                                </div>
                            </form>
                            <br>
                            ...
                            <form>
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="puebas" class="form-control" id="puebas" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="responsable">Área / Persona Responsable</label> <br> <br>
                                        <input type="text" name="responsable" class="form-control" id="responsable" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="evidencias">Evidencias:</label> <br><br>
                                        <input type="text" name="evidencias" class="form-control" id="evidencias" placeholder="">
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                        ...
                        <div style='text-align:center'>
                            ...
                            <form>
                                <div class="row">
                                    <div class="col">
                                        <label for="fecha_inicio_atencion">Fecha de inicio de atención a la PQ</label>
                                        <input type="text" name="fecha_inicio_atencion" class="form-control" id="fecha_inicio_atencion" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="fecha_termino_cap">Fecha de término del CAP</label>
                                        <input type="text" name="fecha_termino_cap"class="form-control" id="fecha_termino_cap"placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="porcentaje_total">Porcentaje total actual de la PQ</label>
                                        <input type="text" name="porcentaje_total" class="form-control" id="porcentaje_total" placeholder="">
                                    </div>
                                </div>
                            </form>
                            <br>
                            <form>
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="actividades" class="form-control" id="actividades" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="responsable_cap">Área / Persona Responsable</label>
                                        <input type="text" name="responsable_cap" class="form-control" id="responsable_cap" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="fecha_inico_final">Fecha Inicial / Final </label><br><br>
                                        <input type="text" name="fecha_inico_final" class="form-control" id="fecha_inico_final" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="producto">Producto: </label><br><br>
                                        <input type="text" name="producto"class="form-control" id="producto" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="porcentaje_cap">%</label><br><br>
                                        <input type="text" name="porcentaje_cap" class="form-control" id="porcentaje_cap" placeholder="">
                                    </div>
                                </div>
                            </form>
                            <br>
                            <form>
                                <div class="form-group">
                                    <label for="comentarios">Comentarios generales de la Subdirección de SSP:</label>
                            ...
                            <form action="">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="fecha_subio_olf" class="form-control" id="fecha_subio_olf" placeholder="">
                                    </div>
                                    <div class="col">
                                        <label for="fecha_revision_oaci">Fecha de revisión de OACI:  </label>
                                        <input type="text" name="fecha_revision_oaci" class="form-control" id="fecha_revision_oaci" placeholder="">
                                    </div>
                                </div>
                            </form>
                            <br>
